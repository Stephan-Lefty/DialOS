...
FELDER = [
    ...
    ("mail_benutzer", "Mail-Benutzername", False),
    ("imap_server", "Posteingang-Server", False),
    ("imap_port", "Posteingang-Port", False),
    ("smtp_server", "Postausgang-Server", False),
    ("smtp_port", "Postausgang-Port", False),
    ("firma", "Firma", False),
