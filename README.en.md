...
![From Debian 13 + GNOME to DialOS - the build in three stages (German)](assets/debian-zu-dialos.png)
...
- **Graphic "From Debian 13 + GNOME to DialOS"** (`assets/debian-zu-dialos.svg`
  ...
  brand sheet and in Quicksand. Generated by `scripts/dialos-grafik-aufbau.py`
  from a list of steps so it keeps pace with the guide; embedded in the README
  and the recipe.
...
- **"Satz löschen" and "Satz wiederholen" in dictation** (2026-09-15, Stephan's
  ...
  löschen" offline), at most one chunk per deletion, command words cut by
