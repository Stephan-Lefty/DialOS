...
| **"Brief als PDF speichern"** (save the letter as PDF) | Puts the letter at `~/Dokumente/brief.pdf`, where a helper finds it or attaches it to an email: "Der Brief liegt jetzt als PDF in Deinen Dokumenten." **No confirmation** - nothing leaves the house, nothing is lost. Since 2026-09-15 (Stephan asked to add PDF creation). Independently of this, every letter lands in the archive as a PDF anyway. Anna names the command after "Diktat beenden" together with reading out and printing. |
| **"Brief drucken"** (print the letter) | **With a confirmation** (since 2026-09-14, for all print commands): "Soll ich den Brief drucken? Sage ja oder nein." If there is nothing to print, the question is skipped. Prints `~/Dokumente/brief.txt`. The letter already carries its footer; it is not added a second time. |
