...
| **"Brief als PDF speichern"** (save the letter as PDF) | Puts the newest letter next to itself as a PDF with the same name (`2026-09-15-1343-Brief.pdf`), where a helper finds it or attaches it to an email: "Der Brief liegt jetzt als PDF in Deinen Dokumenten." **No confirmation** - nothing leaves the house, nothing is lost. Since 2026-09-15 (Stephan asked to add PDF creation). Independently of this, every letter lands in the archive as a PDF anyway. Anna names the command after "Diktat beenden" together with reading out and printing. |
