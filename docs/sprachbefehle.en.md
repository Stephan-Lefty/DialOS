...
| **"Brief vorlesen"** (read the letter) | Reads the newest letter in one go: sentence count, sender, date, text up to the name. **Since 2026-09-17 without the footer and without the note "created by voice input …"** (Stephan: rather information for the recipient, not needed for checking) - both stay in the letter, the PDF and the printout. The note used to count as a sentence. |
