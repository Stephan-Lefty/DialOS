...
![From Debian 13 + GNOME to DialOS (German)](../assets/debian-zu-dialos.png)

The graphic is generated by `scripts/dialos-grafik-aufbau.py` from a list of
steps - when the installation guide changes, update it there and regenerate.
