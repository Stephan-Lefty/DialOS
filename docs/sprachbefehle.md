...
| **„Satz löschen"** *(nur im Diktat)* | Streicht das zuletzt Erkannte - alles seit der vorigen Sprechpause - und sagt, was weg ist: „Gestrichen: Die Rechnung liegt im Schrank bei." Seit 2026-09-15 (Stephan: „wie bauen wir 'Versprecher' ein"). **Gilt nur mit einer halben Sekunde Ruhe davor und danach** - aus normalem Brieftext entstand beim Prüfen gegen Piper sonst ein vollständiges „satz löschen" („Den ersten Satz habe ich gelöscht") bzw. „satz wiederholen". Während Anna antwortet, hört das Diktat nicht mit. |
| **„Satz wiederholen"** *(nur im Diktat)* | Liest das zuletzt Erkannte vor, **ohne** etwas zu löschen: „Zuletzt: …". So merkt ein blinder Nutzer einen Verhörer, bevor er weiterdiktiert. Dieselben Sicherungen wie „Satz löschen". |
