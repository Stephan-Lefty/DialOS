...
| **„Brief als PDF speichern"** | Legt den Brief als `~/Dokumente/brief.pdf` ab, wo ein Helfer ihn findet oder an eine Mail hängt: „Der Brief liegt jetzt als PDF in Deinen Dokumenten." **Ohne Rückfrage** - nichts verlässt das Haus, nichts geht verloren. Seit 2026-09-15 (Stephan: „Können wir pdf erstellen hinzufügen?"). Unabhängig davon landet jeder Brief ohnehin als PDF im Archiv. Anna nennt den Befehl nach „Diktat beenden" zusammen mit Vorlesen und Drucken. |
| **„Brief drucken"** | **Mit Rückfrage** (seit 2026-09-14, gilt für alle Druckbefehle): „Soll ich den Brief drucken? Sage ja oder nein." Ist nichts zu drucken, entfällt die Frage. Druckt `~/Dokumente/brief.txt`. Der Brief trägt seine Fußzeile schon, sie kommt kein zweites Mal dazu. |
