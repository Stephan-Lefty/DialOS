...
- [x] **„Mikrofon ohne Echo" als Voreinstellung für jedes Konto** **ZURÜCKGENOMMEN am selben Abend** (Stephan): verstößt gegen die Regel in `docs/anwendungen.md` - Firefox/Jitsi würden doppelt gefiltert. Rohes Mikrofon als Vorgabe ist Sollzustand. (aus dem
...
- [ ] **Anwendungen: freigegebener Umfang vom 2026-08-18.** Vollständige
  ...
  - [ ] **Radio, Musik, Nachrichten und Podcasts per Sprache** (Stephan, 2026-09-25:
    ...
    Podcast-Folge, zu klären. **Bauplan: [docs/medien-konzept.md](docs/medien-konzept.md).**
    **Die Auswahl kommt aus [docs/medienliste.md](docs/medienliste.md)** -
